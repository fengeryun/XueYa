...
public class HuiFuBean implements Parcelable {
    ...
    protected HuiFuBean(Parcel in) {
        this.data = new ArrayList<DataBean>();
        in.readList(this.data, DataBean.class.getClassLoader());
        this.code = in.readInt();
    }

    public static final Parcelable.Creator<HuiFuBean> CREATOR = new Parcelable.Creator<HuiFuBean>() {
        @Override
        public HuiFuBean createFromParcel(Parcel source) {
            return new HuiFuBean(source);
        }

        @Override
        public HuiFuBean[] newArray(int size) {
            return new HuiFuBean[size];
        }
    };
}
