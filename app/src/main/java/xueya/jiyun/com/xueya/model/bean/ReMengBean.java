...
public class ReMengBean implements Parcelable {
    ...
    protected ReMengBean(Parcel in) {
    ...
    public static final Parcelable.Creator<ReMengBean> CREATOR = new Parcelable.Creator<ReMengBean>() {
        @Override
        public ReMengBean createFromParcel(Parcel source) {
            return new ReMengBean(source);
        }

        @Override
        public ReMengBean[] newArray(int size) {
            return new ReMengBean[size];
        }
    };
}
